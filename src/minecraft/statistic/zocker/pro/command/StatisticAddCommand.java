...
public class StatisticAddCommand extends SubCommand {

	private final List<String> tabCompleteList = new ArrayList<>();

	public StatisticAddCommand() {
		super("add");
	...
	public String getUsage() {
		return Main.STATISTIC_MESSAGE.getString("statistic.prefix") + "§3Type §6/statistic add <player> <type> <amount>";
	}

	@Override
	public String getPermission() {
		return "mzp.statistic.command.statistic.add";
	}
	...
	public void onExecute(CommandSender sender, String[] args) {
		...
		if (args.length == 3) {
			...
			if (target == null) {
				...
				statisticZocker.add(typeString.toUpperCase(), Integer.parseInt(amountString));
				sendAddedMessage(sender, Main.STATISTIC_MESSAGE.getString("statistic.command.statistic.add")
